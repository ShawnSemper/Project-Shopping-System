...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEnterpriseAdminJPanel(JPanel userProcessContainer, ShoppingSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        enterpriseJComboBox.setBackground(new java.awt.Color(255, 255, 243));
        ...
        lblCo.setText("Manage Enterprises Admin");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (username.equals("")) {
            JOptionPane.showMessageDialog(null, "Please set user name!");
            return;
        }
        ...
        JOptionPane.showMessageDialog(null, "Add enterprise admin success!");
